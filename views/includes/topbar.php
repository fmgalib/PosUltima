    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="image">
          ...
          <img src="resources/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image" width="30px">
        </div>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <div class="text-center mb-2 mt-2">
            <a href=""><img src="resources/dist/img/user2-160x160.jpg" class="wd-80 rounded-circle" width="80px" alt="" style="text-align: center;"></a>
